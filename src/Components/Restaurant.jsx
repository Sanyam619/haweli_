  ...
  return (
    <div class=" mt-20 w-full h-full bg-yellow-100 bg-opacity-50">
      <div class="flex flex-col w-full justify-center items-center ">
        ...
        <p class="mb-5 font-semibold text-center">
          Book your food now and experience the exquisite flavors that await you
          at our resort.
        </p>
        <div class="flex flex-row flex-wrap w-full p-4 mx-auto">
          <div class="flex flex-row items-center justify-center w-full">
            <button class="flex" onClick={changepic}>
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
          ...
          <div class="container p-4 mx-auto sm:w-9/12">
            ...
            <div class="mb-6">
              ...
              <p class="text-lg">
                Plot No - 303 , Narbdeshwar Nagar , Bharthauli Road , Jasoiya
                More
                <br />
            ...
            <div class="mb-6">
              <h2 class="mb-2 text-xl font-semibold">Call Us</h2>
            ...
            <div class="mb-6">
              <h2 class="mb-2 text-xl font-semibold">Whatsapp</h2>
              <span class="flex flex-row items-center text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
